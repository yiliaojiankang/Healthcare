...
import { DEFAULT_ADSORB_CONFIG, DEFAULT_DISTANCE_OPTIONS, RenderEvent } from '../constant';
import { calcDistanceTextsByLine, createLineFeature, createPointFeature, getAdsorbFeature, getAdsorbLine, getAdsorbPoint, getLngLat, getPosition, isSameFeature, resetEventLngLat, transLngLat2Position, updateTargetFeature } from '../utils';
...
export var LineMode = /*#__PURE__*/function (_MidPointMode) {
  ...
  _createClass(LineMode, [{
    ...
    value: function getAdsorbPosition(position) {
      ...
      var _getAdsorbFeature = getAdsorbFeature(data, this, position),
