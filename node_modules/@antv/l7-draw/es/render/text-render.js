...
export var TextRender = /*#__PURE__*/function (_LayerRender) {
  ...
  _createClass(TextRender, [{
    ...
    value: function initLayers() {
      ...
      var layer = new PointLayer(options !== null && options !== void 0 ? options : {}).source(featureCollection([])).size('isActive', function (isActive) {
