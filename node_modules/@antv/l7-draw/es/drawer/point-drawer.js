...
export var PointDrawer = /*#__PURE__*/function (_PointMode) {
  ...
  _createClass(PointDrawer, [{
    ...
    value: function setData(points) {
      this.setPointData(points.map(function (point) {
        ...
        point.properties = _objectSpread(_objectSpread({}, getDefaultPointProperties()), (_point$properties = point.properties) !== null && _point$properties !== void 0 ? _point$properties : {});
        return point;
      }));
    }
  }, {
