...
var RectDrawer = exports.RectDrawer = /*#__PURE__*/function (_DragPolygonMode) {
  ...
  _createClass(RectDrawer, [{
    ...
    value: function getDefaultOptions(options) {
      ...
      if (newOptions.helper) {
        newOptions.helper = _objectSpread(_objectSpread({}, newOptions.helper), _helper.DEFAULT_RECT_HELPER_CONFIG);
      }
      return newOptions;
    }
  }, {
    ...
    value: function setData(data) {
      ...
      var result = data.map(function (feature) {
        ...
        feature.properties = _objectSpread(_objectSpread({}, (0, _utils.getDefaultPolygonProperties)()), (_feature$properties = feature.properties) !== null && _feature$properties !== void 0 ? _feature$properties : {});
        var nodes = feature.properties.nodes;
        if (((_nodes = nodes) === null || _nodes === void 0 ? void 0 : _nodes.length) !== 2) {
          var _bbox = (0, _turf.bbox)(feature),
            _bbox2 = _slicedToArray(_bbox, 4),
            lng1 = _bbox2[0],
            lat1 = _bbox2[1],
            lng2 = _bbox2[2],
            lat2 = _bbox2[3];
          nodes = [(0, _utils.createPointFeature)([lng1, lat1]), (0, _utils.createPointFeature)([lng2, lat2])];
    ...
    value: function handleCreatePolygonLine(startNode, endNode) {
      ...
      var positions = (0, _turf.coordAll)((0, _turf.envelope)((0, _turf.featureCollection)([startNode, endNode])));
      ...
      return (0, _utils.createLineFeature)(nodes, properties);
    }
  }, {
    key: "syncPolygonNodes",
    value: function syncPolygonNodes(polygon, nodes) {
      var line = polygon.properties.line;
      var positions = (0, _turf.coordAll)((0, _turf.envelope)((0, _turf.featureCollection)(nodes)));
      ...
      var otherPositions = positions.filter(function (position) {
        return !(0, _lodash.isEqual)(position, nodes[0].geometry.coordinates) && !(0, _lodash.isEqual)(position, nodes[1].geometry.coordinates);
      });
      lineNodes.forEach(function (lineNode, index) {
        ...
        switch (index) {
          ...
          case 3:
            ...
            break;
          case 4:
            position = (0, _lodash.cloneDeep)(nodes[0].geometry.coordinates);
            break;
        }
