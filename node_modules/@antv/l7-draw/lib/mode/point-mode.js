...
var _baseMode = require("./base-mode");
...
var PointMode = exports.PointMode = /*#__PURE__*/function (_BaseMode) {
  ...
  _createClass(PointMode, [{
    ...
    value: function bindPointRenderEvent() {
      ...
      (_this$pointRender = this.pointRender) === null || _this$pointRender === void 0 ? void 0 : _this$pointRender.on(_constant.RenderEvent.UnClick, this.onPointCreate.bind(this));
      (_this$pointRender2 = this.pointRender) === null || _this$pointRender2 === void 0 ? void 0 : _this$pointRender2.on(_constant.RenderEvent.Mousemove, this.onPointMouseMove.bind(this));
      (_this$pointRender3 = this.pointRender) === null || _this$pointRender3 === void 0 ? void 0 : _this$pointRender3.on(_constant.RenderEvent.Mouseout, this.onPointMouseOut.bind(this));
      (_this$pointRender4 = this.pointRender) === null || _this$pointRender4 === void 0 ? void 0 : _this$pointRender4.on(_constant.RenderEvent.Dragstart, this.onPointDragStart.bind(this));
      (_this$pointRender5 = this.pointRender) === null || _this$pointRender5 === void 0 ? void 0 : _this$pointRender5.on(_constant.RenderEvent.Dragging, this.onPointDragging.bind(this));
      (_this$pointRender6 = this.pointRender) === null || _this$pointRender6 === void 0 ? void 0 : _this$pointRender6.on(_constant.RenderEvent.Dragend, this.onPointDragEnd.bind(this));
    }
    /**
     * 创建点Feature
     * @param position
    ...
    value: function handleCreatePoint(position) {
      ...
      var newFeature = (0, _utils.createPointFeature)(position);
    ...
    value: function handlePointHover(point) {
      ...
      if (!(0, _utils.isSameFeature)(point, this.hoverPoint)) {
    ...
    value: function handlePointDragging(point, lngLat) {
      this.setPointData(function (features) {
        return (0, _utils.updateTargetFeature)({
          ...
          data: features,
          targetHandler: function targetHandler(item) {
            item.geometry.coordinates = (0, _utils.transLngLat2Position)(lngLat);
          }
        });
      });
      this.scene.setMapStatus({
    ...
    value: function onPointCreate(e) {
      return this.handleCreatePoint((0, _utils.transLngLat2Position)((0, _utils.getLngLat)(e)));
    }
  }, {
    ...
    value: function onPointDragging(e) {
      ...
      return this.handlePointDragging(dragPoint, (0, _utils.getLngLat)(e));
    }
    /**
     * 拖拽结束点回调
     * @param e
