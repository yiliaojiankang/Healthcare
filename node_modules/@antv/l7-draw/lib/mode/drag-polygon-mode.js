  ...
  _createClass(DragPolygonMode, [{
    ...
    value: function getDefaultOptions(options) {
      var newOptions = _objectSpread(_objectSpread({}, _get(_getPrototypeOf(DragPolygonMode.prototype), "getDefaultOptions", this).call(this, options)), {}, {
        ...
        trigger: 'click',
        autoActive: false,
        helper: (0, _lodash.cloneDeep)(_helper.DEFAULT_DRAG_POLYGON_HELPER_CONFIg)
      });
      if (options.trigger === 'drag') {
        newOptions.helper = _objectSpread(_objectSpread({}, newOptions.helper), _helper.DEFAULT_TRIGGER_DRAG_HELPER_CONFIG);
      }
      return newOptions;
    }
    ...
    value: function bindSceneDragEvent() {
      ...
      this.sceneRender.on(_constant.RenderEvent.Dragstart, this.onSceneDragStart);
      this.sceneRender.on(_constant.RenderEvent.Dragend, this.onSceneDragEnd);
      this.scene.setMapStatus({
        dragEnable: false
      });
    }
    ...
    value: function unbindSceneDragEvent() {
      this.sceneRender.off(_constant.RenderEvent.Dragstart, this.onSceneDragStart);
      this.sceneRender.off(_constant.RenderEvent.Dragend, this.onSceneDragEnd);
      this.scene.setMapStatus({
        dragEnable: true
      });
    }
