 ...
 * 鼠标指针类型
 */
export type ICursorType = 'draw' | 'pointHover' | 'pointDrag' | 'lineHover' | 'lineDrag' | 'polygonHover' | 'polygonDrag';
/**
 * 鼠标指针类型键值对
 */
...
export type AdsorbTargetFeature = Feature | IPointFeature | ILineFeature | IPolygonFeature;
