 ...
 * MapboxService
 */
import type { Bounds, ICoordinateSystemService, IGlobalConfigService, ILngLat, IMapCamera, IMapConfig, IMapService, IMercator, IPoint, IStatusOptions, IViewport, MapStyleConfig, MapStyleName } from '@antv/l7-core';
